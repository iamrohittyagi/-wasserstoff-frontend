...
function Content() {
  ...
  const state_ = [
    { rate: 4, r: "UNDERSTAND" },
    { rate: 3, r: "SOMEWHAT UNDERSTAND" },
    { rate: 2, r: "NOT CLEAR" },
    { rate: 1, r: "WHAT RUBBISH" },
    { rate: 0, r: "CHOOSE RATE" },
  ];
        ...
        <div>
          <div>
            <div class="bg-[#D3D3D3] text-white px-8 py-4 m-2">
              <p class="font-bold  text-center text-slate-500">
                {" "}
                Level of UnderStanding (R) : {percentage}%
              </p>
            </div>
            {modal ? (
              <div>
                ...
                <div>
                  ...
                  >
                    <div class="bg-white px-6 py-14 rounded-md text-center">
                      <h1 class="text-xl mb-6 font-bold text-slate-500">
                        {modal_text}
                      </h1>
                      <select
                        onChange={(e) => {
            ...
            {post_data &&
              post_data.map((el, index) => (
                <div class="mx-2 mt-4 px-2" key={index}>
                  <span
                    class="non-italic font-bold rounded-lg justify-center bg-[#D3D3D3] cursor-pointer text-center hover:italic"
                    onClick={() => getId(el.item_id, el.text)}
