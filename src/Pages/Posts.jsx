...
function Posts() {
  ...
  return (
    <div>
      <section class="bg-[#0492C2] antialiased bg-gray-100 text-gray-600 h-screen my-12 px-4">
        <div class="flex flex-col justify-center h-full">
          <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <div>
              <a
                class="bg-blue-400 mx-3 my-6 py-3 px-7 rounded-lg text-center text-white font-medium"
                href={`/posts/new/content`}
              >
                Create Post
              </a>
            </div>
                        ...
                        <tr>
                          ...
                          <td class="p-2">
                            <div class="flex justify-center">
                              <a
                                class="bg-blue-400 m-3 py-3 px-7 rounded-lg text-center text-white font-medium"
                                href={`/posts/${x.ide}/content`}
                              >
                                Read
                              </a>
                            </div>
